...
namespace bnet.protocol.search {
  ...
  public static partial class Search {
    ...
    static Search() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          ...
          "Y3RzUmVxdWVzdBoaLmJuZXQucHJvdG9jb2wuTk9fUkVTUE9OU0VCA4ABAQ==");
  ...
  public sealed partial class FindMatchesRequest : pb::GeneratedMessage<FindMatchesRequest, FindMatchesRequest.Builder> {
    ...
    public override void WriteTo(pb::CodedOutputStream output) {
      ...
      if (HasUniverse) {
        output.WriteString(1, Universe);
      }
      foreach (global::bnet.protocol.search.Filter element in FiltersList) {
        output.WriteMessage(2, element);
      }
      if (HasStartingIndex) {
        output.WriteUInt32(3, StartingIndex);
      }
      if (HasCount) {
        output.WriteUInt32(4, Count);
      }
    ...
    public static FindMatchesRequest ParseFrom(pb::CodedInputStream input) {
      return ((Builder) CreateBuilder().MergeFrom(input)).BuildParsed();
    }
    public static FindMatchesRequest ParseFrom(pb::CodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(input, extensionRegistry)).BuildParsed();
    }
      ...
      public override Builder MergeFrom(pb::CodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 10: {
              Universe = input.ReadString();
              break;
            }
            case 18: {
              global::bnet.protocol.search.Filter.Builder subBuilder = global::bnet.protocol.search.Filter.CreateBuilder();
  ...
  public sealed partial class FindMatchesResponse : pb::GeneratedMessage<FindMatchesResponse, FindMatchesResponse.Builder> {
    ...
    public override void WriteTo(pb::CodedOutputStream output) {
      int size = SerializedSize;
      if (HasTotalCount) {
        output.WriteUInt32(1, TotalCount);
      }
      foreach (global::bnet.protocol.search.Object element in ObjectsList) {
        output.WriteMessage(2, element);
      }
    ...
    public static FindMatchesResponse ParseFrom(pb::CodedInputStream input) {
      return ((Builder) CreateBuilder().MergeFrom(input)).BuildParsed();
    }
    public static FindMatchesResponse ParseFrom(pb::CodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(input, extensionRegistry)).BuildParsed();
    }
    public static Builder CreateBuilder() { return new Builder(); }
    public override Builder ToBuilder() { return CreateBuilder(this); }
      ...
      public override Builder MergeFrom(pb::CodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 18: {
              global::bnet.protocol.search.Object.Builder subBuilder = global::bnet.protocol.search.Object.CreateBuilder();
              input.ReadMessage(subBuilder, extensionRegistry);
  ...
  public sealed partial class SetObjectRequest : pb::GeneratedMessage<SetObjectRequest, SetObjectRequest.Builder> {
    ...
    public static SetObjectRequest ParseFrom(pb::CodedInputStream input) {
      return ((Builder) CreateBuilder().MergeFrom(input)).BuildParsed();
    }
    public static SetObjectRequest ParseFrom(pb::CodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(input, extensionRegistry)).BuildParsed();
    }
    public static Builder CreateBuilder() { return new Builder(); }
    public override Builder ToBuilder() { return CreateBuilder(this); }
  ...
  public sealed partial class RemoveObjectsRequest : pb::GeneratedMessage<RemoveObjectsRequest, RemoveObjectsRequest.Builder> {
    ...
    public override void WriteTo(pb::CodedOutputStream output) {
      int size = SerializedSize;
      if (HasStartId) {
        output.WriteBytes(1, StartId);
      }
      if (HasEndId) {
        output.WriteBytes(2, EndId);
      }
      UnknownFields.WriteTo(output);
    }
    ...
    public static RemoveObjectsRequest ParseFrom(pb::CodedInputStream input) {
      return ((Builder) CreateBuilder().MergeFrom(input)).BuildParsed();
    }
    public static RemoveObjectsRequest ParseFrom(pb::CodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(input, extensionRegistry)).BuildParsed();
    }
    public static Builder CreateBuilder() { return new Builder(); }
    public override Builder ToBuilder() { return CreateBuilder(this); }
      ...
      public override Builder MergeFrom(pb::CodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 10: {
              StartId = input.ReadBytes();
              break;
            }
            case 18: {
              EndId = input.ReadBytes();
              break;
            }
          }
        }
  ...
  public sealed partial class SearchConfig : pb::GeneratedMessage<SearchConfig, SearchConfig.Builder> {
    ...
    public static SearchConfig ParseFrom(pb::CodedInputStream input) {
      return ((Builder) CreateBuilder().MergeFrom(input)).BuildParsed();
    }
    public static SearchConfig ParseFrom(pb::CodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(input, extensionRegistry)).BuildParsed();
    }
    public static Builder CreateBuilder() { return new Builder(); }
    public override Builder ToBuilder() { return CreateBuilder(this); }
