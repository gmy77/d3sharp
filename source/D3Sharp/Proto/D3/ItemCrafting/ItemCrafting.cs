...
namespace D3.ItemCrafting {
  ...
  public sealed partial class CrafterData : pb::GeneratedMessage<CrafterData, CrafterData.Builder> {
    ...
    public static CrafterData ParseFrom(pb::CodedInputStream input) {
      return ((Builder) CreateBuilder().MergeFrom(input)).BuildParsed();
    }
    public static CrafterData ParseFrom(pb::CodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(input, extensionRegistry)).BuildParsed();
    }
  ...
  public sealed partial class CrafterSavedData : pb::GeneratedMessage<CrafterSavedData, CrafterSavedData.Builder> {
    ...
    public static CrafterSavedData ParseFrom(pb::CodedInputStream input) {
      return ((Builder) CreateBuilder().MergeFrom(input)).BuildParsed();
    }
    public static CrafterSavedData ParseFrom(pb::CodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(input, extensionRegistry)).BuildParsed();
    }
    public static Builder CreateBuilder() { return new Builder(); }
    public override Builder ToBuilder() { return CreateBuilder(this); }
      ...
      public override Builder MergeFrom(pb::CodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 10: {
              global::D3.ItemCrafting.CrafterData.Builder subBuilder = global::D3.ItemCrafting.CrafterData.CreateBuilder();
