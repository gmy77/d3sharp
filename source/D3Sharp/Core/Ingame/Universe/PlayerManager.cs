...
namespace D3Sharp.Core.Ingame.Universe
{
    public class PlayerManager:IMessageConsumer
    {
        ...
        public void OnNewPlayer(GameClient client, JoinBNetGameMessage message)
        {
            ...
            //den of evil:
            //client.Player.Toon.Position.X = 2526.250000f;
            //client.Player.Toon.Position.Y = 2098.750000f;
            //client.Player.Toon.Position.Z = -5.381495f;

            //inn:
            client.Player.Toon.Position.X = 2996.250000f;
            client.Player.Toon.Position.Y = 2793.750000f;
            client.Player.Toon.Position.Z = 24.045330f;
