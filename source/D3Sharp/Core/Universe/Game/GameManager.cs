...
namespace D3Sharp.Core.Universe.Game
{
    public class GameManager:IMessageConsumer
    {
        public Universe Universe { get; private set; }
        public List<GameClient> Clients = new List<GameClient>();

        public GameManager(Universe universe)
        {
        ...
        public void OnNewPlayer(GameClient client, JoinBNetGameMessage message)
        {
            ...
            client.BnetClient = Core.Games.GameManager.AvailableGames[(ulong)message.Field2].Clients.FirstOrDefault();
