...
namespace Mooege.Core.GS.Ticker
{
    ...
    /// </summary>
    public class TickTimer<T> : IUpdateable
    {
        /// <summary>
        ...
        /// </summary>
        public Action<T> CompletionAction { get; private set; }

        /// <summary>
        /// Parameter passed to the CompleteAction on timeout
        /// </summary>
        ...
        public TickTimer(Game game, int timeoutTick, Action<T> completionCallback, T parameter)
        {
        ...
        public virtual void Update(int tickCounter)
        {
            ...
            if (this.CompletionAction != null) // if a completition action exists.
                this.CompletionAction(Parameter); //call it once the timer time-outs.
        ...
        public static TickTimer<T> WaitTicks(Game game, int ticks, Action<T> completionCallback, T parameter)
        {
            return new RelativeTickTimer<T>(game, ticks, completionCallback, parameter);
        }
    }
    ...
    /// Relative tick timer.
    /// </summary>
    public class RelativeTickTimer<T> : TickTimer<T>
    {
        /// <summary>
        ...
        /// <param name="ticks">Relative tick amount taken to timeout.</param>
        /// <param name="completionCallback">The completition action to be called on timeout.</param>
        public RelativeTickTimer(Game game, int ticks, Action<T> completionCallback, T parameter)
            : base(game, game.TickCounter + ticks, completionCallback, parameter)
        { }
    }
