    ...
    public class Game : IMessageConsumer
    {
        ...
        private void SendNewPlayerMessage(Player target, Player joinedPlayer)
        {
            target.InGameClient.SendMessage(new NewPlayerMessage
            {
                ...
                ToonId = new EntityId() { High = joinedPlayer.Toon.D3EntityID.IdHigh, Low = joinedPlayer.Toon.D3EntityID.IdLow }, //Toon
                GameAccountId = new EntityId() { High = joinedPlayer.Toon.GameAccount.BnetEntityId.High, Low = joinedPlayer.Toon.GameAccount.BnetEntityId.Low }, //GameAccount
