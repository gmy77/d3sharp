...
namespace Mooege.Core.Common.Items.ItemCreation
{
    class WeaponAttributeCreator : IItemAttributeCreator
    {
        ...
        {
            item.Attributes[GameAttribute.Skill] = 1;
...
//             item.AttributeList.Add(new NetAttributeKeyValue{ Attribute = GameAttribute.Attributes[0x0089], Float = attackspeed * heroAttackspeed,}); // Attacks_Per_Second_Total              
            ...
            item.Attributes[GameAttribute.Damage_Weapon_Delta, 0] = 1f;
            item.Attributes[GameAttribute.Damage_Weapon_Delta_SubTotal, 0] = 1f;
            ...
            item.Attributes[GameAttribute.Damage_Weapon_Delta_Total, 0] = 1f;
            item.Attributes[GameAttribute.Damage_Weapon_Delta_Total_All] = 1f;
            ...
            item.Attributes[GameAttribute.Damage_Weapon_Min_Total_All] = 2f;
...
//             item.AttributeList.Add(new NetAttributeKeyValue{ Attribute = GameAttribute.Attributes[0x009D], Float = 2f,});                  //Damage_Weapon_Min_Total_All
            ...
            item.Attributes[GameAttribute.Damage_Weapon_Delta_Total_MainHand, 0] = 1f;
