    ...
    public class CreateHeroMessage : GameMessage
    {
        ...
        public int Field1;
        int _Field2;
        public int Field2 { get { return _Field2; } set { if(value < 0 || value > 0x1FFFFFFF) throw new ArgumentOutOfRangeException(); _Field2 = value; } }
    ...
    public class PlayLineParams
    {
        ...
        public string Field10 { get { return _Field10; } set { if(value != null && value.Length > 49) throw new ArgumentOutOfRangeException(); _Field10 = value; } }
        public int Field11;
        public int Field12;
        public int Field13;
        public int Field14;
    ...
    public class ACDTranslateArcMessage : GameMessage
    {
        ...
        public Vector3D Field2;
        int _Field3;
        public int Field3 { get { return _Field3; } set { if(value < 0 || value > 0xFFFFFF) throw new ArgumentOutOfRangeException(); _Field3 = value; } }
        int _Field4;
    ...
    public class ACDTranslateFixedMessage : GameMessage
    {
        ...
        public Vector3D Field1;
        int _Field2;
        public int Field2 { get { return _Field2; } set { if(value < 0 || value > 0xFFFFFF) throw new ArgumentOutOfRangeException(); _Field2 = value; } }
        int _Field3;
    ...
    public class ACDTranslateSnappedMessage : GameMessage
    {
        ...
        public bool Field3;
        int _Field4;
        public int Field4 { get { return _Field4; } set { if(value < 0 || value > 0xFFFFFF) throw new ArgumentOutOfRangeException(); _Field4 = value; } }
    ...
    public class ACDTranslateNormalMessage : GameMessage
    {
        ...
        public float? Field4;
        int? _Field5;
        public int? Field5 { get { return _Field5; } set { if(value.HasValue && (value.Value < 0 || value.Value > 0xFFFFFF)) throw new ArgumentOutOfRangeException(); _Field5 = value; } }
        int? _Field6;
    ...
    {
        int _Field0;
        public int Field0 { get { return _Field0; } set { if(value < -1 || value > 8) throw new ArgumentOutOfRangeException(); _Field0 = value; } }
    ...
    {
        int _Field0;
        public int Field0 { get { return _Field0; } set { if(value < 0 || value > 10) throw new ArgumentOutOfRangeException(); _Field0 = value; } }
        public float Field1;
    ...
    public class AssignSkillMessage : GameMessage
    {
        public int snoPower;
        int _Field1;
        public int Field1 { get { return _Field1; } set { if(value < 0 || value > 28) throw new ArgumentOutOfRangeException(); _Field1 = value; } }
    ...
    public class MapRevealSceneMessage : GameMessage
    {
        ...
        public int Field3;
        int _Field4;
        public int Field4 { get { return _Field4; } set { if(value < 0 || value > 7) throw new ArgumentOutOfRangeException(); _Field4 = value; } }
    ...
    {
        int _Field0;
        public int Field0 { get { return _Field0; } set { if(value < -1 || value > 14) throw new ArgumentOutOfRangeException(); _Field0 = value; } }
        public bool Field1;
    ...
    public class PlayerInteractMessage : GameMessage
    {
        ...
        int _Field1;
        public int Field1 { get { return _Field1; } set { if(value < -1 || value > 0) throw new ArgumentOutOfRangeException(); _Field1 = value; } }
    ...
    public class InvLoc
    {
        public int Field0;
        int _Field1;
        public int Field1 { get { return _Field1; } set { if(value < -1 || value > 28) throw new ArgumentOutOfRangeException(); _Field1 = value; } }
        public int Field2;
        public int Field3;
    ...
    {
        int[] _aSkillSNOs;
        public int[] aSkillSNOs { get { return _aSkillSNOs; } set { if(value != null && value.Length > 128) throw new ArgumentOutOfRangeException(); _aSkillSNOs = value; } }

        public override void Parse(GameBitBuffer buffer)
        {
            aSkillSNOs = new int[buffer.ReadInt(8)];
            for(int i = 0;i < _aSkillSNOs.Length;i++) _aSkillSNOs[i] = buffer.ReadInt(32);
        }

        public override void Encode(GameBitBuffer buffer)
        {
            buffer.WriteInt(8, aSkillSNOs.Length);
            for(int i = 0;i < _aSkillSNOs.Length;i++) buffer.WriteInt(32, _aSkillSNOs[i]);
        }
    ...
    public class HeroStateData
    {
        ...
        public int Field2;
        int _Field3;
        public int Field3 { get { return _Field3; } set { if(value < 0 || value > 0x1FFFFFFF) throw new ArgumentOutOfRangeException(); _Field3 = value; } }
    ...
    public class PlayerSavedData
    {
        ...
        public HotbarButtonData[] Field0 { get { return _Field0; } set { if(value != null && value.Length != 9) throw new ArgumentOutOfRangeException(); _Field0 = value; } }
        SkillKeyMapping[] _Field1;
        public SkillKeyMapping[] Field1 { get { return _Field1; } set { if(value != null && value.Length != 15) throw new ArgumentOutOfRangeException(); _Field1 = value; } }
        public int Field2;
        public int Field3;
        public HirelingSavedData Field4;
        public int Field5;
        public LearnedLore Field6;
        int[] _snoActiveSkills;
        public int[] snoActiveSkills { get { return _snoActiveSkills; } set { if(value != null && value.Length != 6) throw new ArgumentOutOfRangeException(); _snoActiveSkills = value; } }
        int[] _snoTraits;
        ...
        int[] _m_SeenTutorials;
        public int[] m_SeenTutorials { get { return _m_SeenTutorials; } set { if(value != null && value.Length != 64) throw new ArgumentOutOfRangeException(); _m_SeenTutorials = value; } }
        ...
        public void Parse(GameBitBuffer buffer)
        {
            ...
            for(int i = 0;i < _m_SeenTutorials.Length;i++) _m_SeenTutorials[i] = buffer.ReadInt(32);
        }

        public void Encode(GameBitBuffer buffer)
        {
            for(int i = 0;i < _Field0.Length;i++) _Field0[i].Encode(buffer);
            for(int i = 0;i < _Field1.Length;i++) _Field1[i].Encode(buffer);
            buffer.WriteInt(32, Field2);
            buffer.WriteInt(32, Field3);
            Field4.Encode(buffer);
            buffer.WriteInt(32, Field5);
            Field6.Encode(buffer);
            for(int i = 0;i < _snoActiveSkills.Length;i++) buffer.WriteInt(32, _snoActiveSkills[i]);
            for(int i = 0;i < _snoTraits.Length;i++) buffer.WriteInt(32, _snoTraits[i]);
            Field9.Encode(buffer);
            for(int i = 0;i < _m_SeenTutorials.Length;i++) buffer.WriteInt(32, _m_SeenTutorials[i]);
        }
    ...
    public class SkillKeyMapping
    {
        ...
        public int Field1;
        int _Field2;
        public int Field2 { get { return _Field2; } set { if(value < 0 || value > 9) throw new ArgumentOutOfRangeException(); _Field2 = value; } }
    ...
    public class NewPlayerMessage : GameMessage
    {
        ...
        public string Field1 { get { return _Field1; } set { if(value != null && value.Length > 128) throw new ArgumentOutOfRangeException(); _Field1 = value; } }
        public string _Field2;
        public string Field2 { get { return _Field2; } set { if(value != null && value.Length > 101) throw new ArgumentOutOfRangeException(); _Field2 = value; } }
        int _Field3;
        public int Field3 { get { return _Field3; } set { if(value < -1 || value > 22) throw new ArgumentOutOfRangeException(); _Field3 = value; } }
        int _Field4;
        public int Field4 { get { return _Field4; } set { if(value < -1 || value > 4) throw new ArgumentOutOfRangeException(); _Field4 = value; } }
        public int snoActorPortrait;
        int _Field6;
        public int Field6 { get { return _Field6; } set { if(value < 0 || value > 127) throw new ArgumentOutOfRangeException(); _Field6 = value; } }
