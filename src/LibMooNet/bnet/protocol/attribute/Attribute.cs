...
namespace bnet.protocol.attribute {
  ...
  public sealed partial class Variant : pb::GeneratedMessage<Variant, Variant.Builder> {
    ...
    private static readonly uint[] _variantFieldTags = new uint[] { 50, 16, 82, 33, 66, 24, 58, 42, 72 };
    ...
    private global::bnet.protocol.EntityId entityidValue_;
    public bool HasEntityidValue {
      get { return hasEntityidValue; }
    }
    public global::bnet.protocol.EntityId EntityidValue {
      get { return entityidValue_ ?? global::bnet.protocol.EntityId.DefaultInstance; }
    }
    
    public override bool IsInitialized {
      get {
        if (HasEntityidValue) {
          if (!EntityidValue.IsInitialized) return false;
        }
        return true;
      }
    }
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      ...
      if (hasStringValue) {
        output.WriteString(5, field_names[7], StringValue);
      }
      if (hasBlobValue) {
        output.WriteBytes(6, field_names[0], BlobValue);
      }
      if (hasMessageValue) {
        output.WriteBytes(7, field_names[6], MessageValue);
      }
      if (hasFourccValue) {
        output.WriteString(8, field_names[4], FourccValue);
      }
      if (hasUintValue) {
        output.WriteUInt64(9, field_names[8], UintValue);
      }
      if (hasEntityidValue) {
        output.WriteMessage(10, field_names[2], EntityidValue);
      }
    ...
    public override int SerializedSize {
      get {
        ...
        if (hasEntityidValue) {
          size += pb::CodedOutputStream.ComputeMessageSize(10, EntityidValue);
        }
    ...
    public sealed partial class Builder : pb::GeneratedBuilder<Variant, Builder> {
      ...
      public override Builder MergeFrom(Variant other) {
        ...
        if (other.HasEntityidValue) {
          MergeEntityidValue(other.EntityidValue);
        }
          ...
          switch (tag) {
            ...
            case 82: {
              ...
              if (result.hasEntityidValue) {
                subBuilder.MergeFrom(EntityidValue);
              }
              input.ReadMessage(subBuilder, extensionRegistry);
              EntityidValue = subBuilder.BuildPartial();
              break;
            }
          }
        }
      ...
      public Builder SetEntityidValue(global::bnet.protocol.EntityId value) {
        pb::ThrowHelper.ThrowIfNull(value, "value");
        PrepareBuilder();
      ...
      public Builder SetEntityidValue(global::bnet.protocol.EntityId.Builder builderForValue) {
      ...
      public Builder MergeEntityidValue(global::bnet.protocol.EntityId value) {
        pb::ThrowHelper.ThrowIfNull(value, "value");
        PrepareBuilder();
        if (result.hasEntityidValue &&
            result.entityidValue_ != global::bnet.protocol.EntityId.DefaultInstance) {
            result.entityidValue_ = global::bnet.protocol.EntityId.CreateBuilder(result.entityidValue_).MergeFrom(value).BuildPartial();
        } else {
          result.entityidValue_ = value;
        }
        result.hasEntityidValue = true;
