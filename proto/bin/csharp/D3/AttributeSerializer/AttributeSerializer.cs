...
namespace D3.AttributeSerializer {
  ...
  public sealed partial class SavedAttribute : pb::GeneratedMessage<SavedAttribute, SavedAttribute.Builder> {
    ...
    public override void WriteTo(pb::CodedOutputStream output) {
      ...
      if (HasKey) {
        output.WriteSInt32(1, Key);
      }
      if (HasValue) {
        output.WriteSInt32(2, Value);
      }
    ...
    public static SavedAttribute ParseFrom(pb::CodedInputStream input) {
      return ((Builder) CreateBuilder().MergeFrom(input)).BuildParsed();
    }
    public static SavedAttribute ParseFrom(pb::CodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(input, extensionRegistry)).BuildParsed();
    }
  ...
  public sealed partial class SavedAttributes : pb::GeneratedMessage<SavedAttributes, SavedAttributes.Builder> {
    ...
    public override void WriteTo(pb::CodedOutputStream output) {
      int size = SerializedSize;
      if (HasGbHandle) {
        output.WriteMessage(1, GbHandle);
      }
      foreach (global::D3.AttributeSerializer.SavedAttribute element in AttributesList) {
    ...
    public static SavedAttributes ParseFrom(pb::CodedInputStream input) {
      return ((Builder) CreateBuilder().MergeFrom(input)).BuildParsed();
    }
    public static SavedAttributes ParseFrom(pb::CodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(input, extensionRegistry)).BuildParsed();
    }
    public static Builder CreateBuilder() { return new Builder(); }
    public override Builder ToBuilder() { return CreateBuilder(this); }
      ...
      public override Builder MergeFrom(pb::CodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 18: {
              global::D3.AttributeSerializer.SavedAttribute.Builder subBuilder = global::D3.AttributeSerializer.SavedAttribute.CreateBuilder();
              input.ReadMessage(subBuilder, extensionRegistry);
