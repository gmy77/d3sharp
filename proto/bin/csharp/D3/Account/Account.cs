...
namespace D3.Account {
  ...
  public static partial class Account {
    ...
    static Account() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          ...
          "SXRlbUNyYWZ0aW5nLnByb3RvIvIBChNCYW5uZXJDb25maWd1cmF0aW9uEhQK" + 
          "DGJhbm5lcl9pbmRleBgBIAIoDRISCgpzaWdpbF9tYWluGAIgAigFEhQKDHNp" + 
          "Z2lsX2FjY2VudBgDIAIoBRIbChNwYXR0ZXJuX2NvbG9yX2luZGV4GAQgAigF" + 
          "Eh4KFmJhY2tncm91bmRfY29sb3JfaW5kZXgYBSACKAUSGQoRc2lnaWxfY29s" + 
          "b3JfaW5kZXgYBiACKAUSFwoPcGxhY2VtZW50X2luZGV4GAcgAigFEg8KB3Bh" + 
          "dHRlcm4YCCACKAUSGQoRdXNlX3NpZ2lsX3ZhcmlhbnQYCSACKAgixQEKBkRp" + 
          "Z2VzdBIPCgd2ZXJzaW9uGAEgAigNEjcKE2xhc3RfcGxheWVkX2hlcm9faWQY" + 
          "AiACKAsyGi5EMy5PbmxpbmVTZXJ2aWNlLkVudGl0eUlkEj0KFGJhbm5lcl9j" + 
          "b25maWd1cmF0aW9uGAMgAigLMh8uRDMuQWNjb3VudC5CYW5uZXJDb25maWd1" + 
          "cmF0aW9uEg0KBWZsYWdzGAQgAigNIiMKBUZsYWdzEhoKFkhBUkRDT1JFX0hF" + 
          "Uk9fVU5MT0NLRUQQASLQAgoPU2F2ZWREZWZpbml0aW9uEg8KB3ZlcnNpb24Y" + 
          "ASACKA0SIgoGZGlnZXN0GAIgASgLMhIuRDMuQWNjb3VudC5EaWdlc3QSQQoQ" + 
          "c2F2ZWRfYXR0cmlidXRlcxgDIAIoCzInLkQzLkF0dHJpYnV0ZVNlcmlhbGl6" + 
          "ZXIuU2F2ZWRBdHRyaWJ1dGVzEjUKGW5vcm1hbF9zaGFyZWRfc2F2ZWRfaXRl" + 
          "bXMYBCABKAsyEi5EMy5JdGVtcy5JdGVtTGlzdBI3ChtoYXJkY29yZV9zaGFy" + 
          "ZWRfc2F2ZWRfaXRlbXMYBSABKAsyEi5EMy5JdGVtcy5JdGVtTGlzdBI9ChJj" + 
          "cmFmdGVyX3NhdmVkX2RhdGEYBiABKAsyIS5EMy5JdGVtQ3JhZnRpbmcuQ3Jh" + 
          "ZnRlclNhdmVkRGF0YRIWCg5zZWVuX3R1dG9yaWFscxgHIAMoDw==");
  ...
  public sealed partial class BannerConfiguration : pb::GeneratedMessage<BannerConfiguration, BannerConfiguration.Builder> {
    ...
    private bool useSigilVariant_ = false;
    ...
    public override void WriteTo(pb::CodedOutputStream output) {
      ...
      if (HasBannerIndex) {
        output.WriteUInt32(1, BannerIndex);
      }
      if (HasSigilMain) {
        output.WriteInt32(2, SigilMain);
      }
      if (HasSigilAccent) {
        output.WriteInt32(3, SigilAccent);
      }
      if (HasPatternColorIndex) {
        output.WriteInt32(4, PatternColorIndex);
      }
      if (HasBackgroundColorIndex) {
        output.WriteInt32(5, BackgroundColorIndex);
      }
      if (HasSigilColorIndex) {
        output.WriteInt32(6, SigilColorIndex);
      }
      if (HasPlacementIndex) {
        output.WriteInt32(7, PlacementIndex);
      }
      if (HasPattern) {
        output.WriteInt32(8, Pattern);
      }
      if (HasUseSigilVariant) {
        output.WriteBool(9, UseSigilVariant);
      }
    ...
    public static BannerConfiguration ParseFrom(pb::CodedInputStream input) {
      return ((Builder) CreateBuilder().MergeFrom(input)).BuildParsed();
    }
    public static BannerConfiguration ParseFrom(pb::CodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
      return ((Builder) CreateBuilder().MergeFrom(input, extensionRegistry)).BuildParsed();
    }
      ...
      public override Builder MergeFrom(pb::CodedInputStream input, pb::ExtensionRegistry extensionRegistry) {
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 8: {
              BannerIndex = input.ReadUInt32();
              break;
            }
            case 16: {
              SigilMain = input.ReadInt32();
              break;
            }
            case 24: {
              SigilAccent = input.ReadInt32();
              break;
            }
            case 32: {
              PatternColorIndex = input.ReadInt32();
              break;
            }
            case 40: {
            ...
            case 48: {
              SigilColorIndex = input.ReadInt32();
              break;
            }
            case 56: {
              PlacementIndex = input.ReadInt32();
              break;
            }
            case 64: {
  ...
  public sealed partial class Digest : pb::GeneratedMessage<Digest, Digest.Builder> {
    ...
    public override void WriteTo(pb::CodedOutputStream output) {
      ...
      if (HasLastPlayedHeroId) {
        output.WriteMessage(2, LastPlayedHeroId);
      }
      if (HasBannerConfiguration) {
        output.WriteMessage(3, BannerConfiguration);
      }
      if (HasFlags) {
        output.WriteUInt32(4, Flags);
      }
      UnknownFields.WriteTo(output);
    }
  ...
  public sealed partial class SavedDefinition : pb::GeneratedMessage<SavedDefinition, SavedDefinition.Builder> {
    ...
    public override void WriteTo(pb::CodedOutputStream output) {
      ...
      if (HasNormalSharedSavedItems) {
        output.WriteMessage(4, NormalSharedSavedItems);
      }
      if (HasHardcoreSharedSavedItems) {
        output.WriteMessage(5, HardcoreSharedSavedItems);
      }
      if (HasCrafterSavedData) {
        output.WriteMessage(6, CrafterSavedData);
      }
